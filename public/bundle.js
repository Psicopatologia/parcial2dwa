...
var url = 'https://dwaapi.juvasquez88.now.sh/soatdwa';

function soat() {
  return _soat.apply(this, arguments);
}
    ...
    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            console.log(json);
            thhead = [createElement('th', {
              scope: "col"
            }, ['status']), createElement('th', {
              scope: "col"
            }, ['brand']), createElement('th', {
              scope: "col"
            }, ['Lisence plate']), createElement('th', {
              scope: "col"
            }, ['Valid From']), createElement('th', {
              scope: "col"
            }, ['Valid until'])];
